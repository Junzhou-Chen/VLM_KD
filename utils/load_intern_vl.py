...
class InternVL:
    def __init__(self,
                 model_name: str = "OpenGVLab/InternVL3_5-14B",
                 local_files_only: bool = True):
        self.patch_transformers_remote_code_compat()
    ...
    def patch_transformers_remote_code_compat(self):
    ...
    def load_video(self, video_path: str, bound=None, input_size: int=448, max_num=1, num_segments=64):
    ...
    def process_video_message(self,
        ...
        if video_path:
            ...
            pixel_values = pixel_values.to(dtype=self.dtype, device=self.model_device())
    ...
    #     print(prompt)
    #     response, history = self.process_video_message(
