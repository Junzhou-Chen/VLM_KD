...
class InternVL:
    ...
    def process_message(self, message, max_new_tokens: int = 512):
...
#
#     def __init__(self,
#                  model_name: str = "OpenGVLab/InternVL3_5-8B-HF"):
#         self.model = AutoModel.from_pretrained(
#             model_name,
#             torch_dtype=torch.bfloat16,
#             low_cpu_mem_usage=True,
#             # attn_implementation="flash_attention_2",
#             device_map="auto"  # Let accelerate handle the mapping automatically
#         ).eval()
#
...
#
#     def load_video(self, video_path: str, bound=None, input_size: int=448, max_num=1, num_segments=32):
...
#         response, history = self.model(self.tokenizer, pixel_values, prompt, generation_config,
